<header class="dashboard-header">
					<div class="d-flex align-items-center justify-content-end">
						<h4 class="m0 d-none d-lg-block">Admin Dashboard</h4>
						...
						<div class="user-data position-relative">
							...
							<div class="user-name-data">
								<ul class="dropdown-menu" aria-labelledby="profile-dropdown">
									<li>
										<a class="dropdown-item d-flex align-items-center" href="{{ route('admin.profile')  }}"><img src="{{ asset('../assets/images/lazy.svg') }}" data-src="{{ asset('../assets/images/icon/icon_23.svg') }}" alt="" class="lazy-img"><span class="ms-2 ps-1">Profile</span></a>
									</li>
									<li>
										<a class="dropdown-item d-flex align-items-center" href="{{ route('change.password')  }}"><img src="{{ asset('../assets/images/lazy.svg') }}" data-src="{{ asset('../assets/images/icon/icon_24.svg') }}" alt="" class="lazy-img"><span class="ms-2 ps-1">Change Password</span></a>
									</li>
