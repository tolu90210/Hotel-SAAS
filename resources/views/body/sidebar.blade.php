			...
			<div class="position-relative">
				<div class="logo d-md-block d-flex align-items-center justify-content-between plr bottom-line pb-30">
					<a href="{{ url('/dashboard') }}">
						<img src="{{ asset('backend/assets/images/logo/logo_01.svg') }}" alt="">
					</a>
				...
				<nav class="dasboard-main-nav pt-30 pb-30 bottom-line">
					<ul class="style-none">
						<li class="plr"><a href="{{ url('/dashboard') }}" class="d-flex w-100 align-items-center active">
							<img src="{{ asset('backend/assets/images/icon/icon_1_active.svg') }}" alt="">
							<span>Dashboard</span>
						</a></li>
						<li class="plr"><a href="message.html" class="d-flex w-100 align-items-center">
							<img src="{{ asset('backend/assets/images/icon/icon_2.svg') }}" alt="">
							<span>Message</span>
						</a></li>
				...
				<div class="plr">
					<a href="{{ route('admin.logout') }}" class="d-flex w-100 align-items-center logout-btn">
						<div class="icon tran3s d-flex align-items-center justify-content-center rounded-circle"><img src="{{ asset('backend/assets/images/icon/icon_41.svg') }}" alt=""></div>
						<span>Logout</span>
					</a>
				</div>
			</div>
