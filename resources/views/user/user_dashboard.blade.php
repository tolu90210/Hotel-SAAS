...
<head>
    ...
    <meta property="og:title" content="Homy-Real Estate User Dashboard">
	...
	<title>Homy-Real Estate User Dashboard</title>
	<!-- Favicon -->
            ...
            <div class="modal-dialog modal-fullscreen modal-dialog-centered">
                <div class="container">
                    <div class="remove-account-popup text-center modal-content">
						...
						<img src="{{ asset('backend_frontend/assets/images/lazy.svg') }}" data-src="{{ asset('backend_frontend/assets/images/icon/icon_22.svg') }}" alt="" class="lazy-img m-auto">
						<h2>Are you sure?</h2>
